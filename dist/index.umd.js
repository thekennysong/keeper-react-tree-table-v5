(function (global, factory) {
  ...
  (global = global || self, factory(global.cpReactTreeTable = {}, global.React));
    ...
    _createClass(TreeTableHeader, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default.createElement("div", {
          ...
          return /*#__PURE__*/React__default.createElement(HeaderCellWrapper, {
            key: indexKey,
    ...
    _createClass(CellWrapper, [{
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            columnTotal = _this$props.columnTotal,
            grow = _this$props.grow,
            basis = _this$props.basis,
            background = _this$props.background,
            indexKey = _this$props.indexKey;
        return /*#__PURE__*/React__default.createElement("div", {
  ...
  var TreeState = /*#__PURE__*/function () {
    ...
    _createClass(TreeState, [{
      ...
      value: function _showRowsInRange(source) {
        var from = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
        var to = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : source.data.length;
        var expandAllClicked = arguments.length > 3 ? arguments[3] : undefined;
      ...
      value: function _showRowsInStarLevel(source) {
        ...
        var updatedRange = TreeState.sliceRows(source, from, to).map(function (model, i) {
          ...
          if (model.metadata.depth > 0 && !model.$state.isVisible) {
            ...
            if (!isStared && (source.data.reduce(function (acc, row, index) {
              debugger;

              if (index > source.data.map(function (row2) {
                return row2.data.name + row2.data.type;
              }).indexOf(model.data.name + model.data.type) && acc !== 'false' && acc !== 'true') {
                if (row.data.isStared) {
                  return acc + 'true';
                } else if (row.data.type == 'Data') {
                  return acc + 'false';
                } else {
                  return acc + '';
                }
      ...
      value: function _showRowsInRangeAccountLevel(source) {
        var from = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
        var to = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : source.data.length;
        var expandAllClicked = arguments.length > 3 ? arguments[3] : undefined;
        var depthLimit = arguments.length > 4 ? arguments[4] : undefined;
        ...
        var updatedRange = TreeState.sliceRows(source, from, to).map(function (model, i) {
          if (model.metadata.depth > 0 && !model.$state.isVisible) {
            ...
            if (model.data.type === 'transaction' || model.data.type === 'transactionEntity') {
              model.$state.isVisible = false;
            }
          }
      ...
      key: "expandToAccountLevel",
      value: function expandToAccountLevel(source, depthLimit) {
        return TreeState._showRowsInRangeAccountLevel(source, undefined, undefined, true, depthLimit);
      }
    }, {
      key: "collapseAll",
      ...
      value: function toggleChildren(source, model) {
        ...
        return shouldToggleOpen ? TreeState._showRowsInRange(source, model.metadata.index + 1, lastChildIndex, false, currentDepth + 1) : TreeState._hideRowsInRange(source, model.metadata.index + 1, lastChildIndex);
      }
    }, {
      key: "updateData",
  ...
  var VirtualListRow = /*#__PURE__*/function (_Component) {
    ...
    _createClass(VirtualListRow, [{
      ...
      value: function render() {
        ...
        var memoed = memoizeOne(createRow);
        var row = memoed(model, data, this.handleChange);
        return /*#__PURE__*/React__default.createElement("div", {
          ...
          return /*#__PURE__*/React__default.createElement(CellWrapper, {
            key: indexKey,
            indexKey: indexKey,
            row: row,
  ...
  function createRefPolyfill() {
    if (React__default.createRef != null) {
  ...
  var VirtualList = /*#__PURE__*/function (_Component) {
    ...
    function VirtualList() {
      ...
      _defineProperty(_assertThisInitialized(_this), "handleScroll", lodash_1(function () {
  ...
  var TreeTable = /*#__PURE__*/function (_Component) {
    ...
    _createClass(TreeTable, [{
      ...
      value: function render() {
        ...
        }, /*#__PURE__*/React__default.createElement(TreeTableHeader, {
          columns: columnsDef,
          height: headerHeight
        }), value.hasData && /*#__PURE__*/React__default.createElement(VirtualList, {
          data: value,
          columns: columnsDef,
